...
mcp23s17::mcp23s17(const uint8_t csPin,const uint8_t haenAdrs){
	_spiTransactionsSpeed = 0;
	postSetup((int8_t)csPin,NULL, haenAdrs);
}

mcp23s17::mcp23s17(const uint8_t csPin,const uint8_t haenAdrs,uint32_t spispeed){
	postSetup((int8_t)csPin,NULL, haenAdrs,spispeed);
}
mcp23s17::mcp23s17(csFct fct,const uint8_t haenAdrs){
	_spiTransactionsSpeed = 0;
	postSetup(-1, fct,haenAdrs);
}

mcp23s17::mcp23s17(csFct fct, uint8_t haenAdrs,uint32_t spispeed){
	postSetup(-1, fct,haenAdrs,spispeed);
}


void mcp23s17::postSetup(const int8_t csPin, csFct fct, const uint8_t haenAdrs,uint32_t spispeed){
	#if defined (SPI_HAS_TRANSACTION)
